...
#include "sycl_code/common_templates.h"
...
void gemm_4bit_inference(int m, int n, int k, sycl::half * A,  unsigned char* B,  float *absmax, sycl::half * out,  int lda, int ldb, int ldc, int blocksize)
{ gemm_4bit_inference<sycl::half>(m, n, k, A, B, absmax,  out, lda, ldb, ldc, blocksize); }

void gemm_4bit_inference_naive_fp16(int m, int n, int k, sycl::half * A,  unsigned char* B,  float *absmax, float *datatype, sycl::half * out,  int lda, int ldb, int ldc, int blocksize)
{ gemm_4bit_inference_naive<sycl::half, 16>(m, n, k, A, B, absmax,  datatype, out, lda, ldb, ldc, blocksize); }

void gemm_4bit_inference_naive_bf16(int m, int n, int k, sycl::ext::oneapi::bfloat16 * A,  unsigned char* B,  float *absmax, float *datatype, sycl::ext::oneapi::bfloat16 * out,  int lda, int ldb, int ldc, int blocksize)
{ gemm_4bit_inference_naive<sycl::ext::oneapi::bfloat16, 16>(m, n, k, A, B, absmax,  datatype, out, lda, ldb, ldc, blocksize); }
...
MAKE_FUNC32(momentum, MOMENTUM, sycl::half, 16)
MAKE_FUNC32(adam, ADAM, float, fp32)
MAKE_FUNC32(adam, ADAM, sycl::half, fp16)
MAKE_FUNC32(adam, ADAM, sycl::ext::oneapi::bfloat16, bf16)
MAKE_FUNC32(rmsprop, RMSPROP, float, 32)
MAKE_FUNC32(rmsprop, RMSPROP, sycl::half, 16)
MAKE_FUNC32(lion, LION, float, fp32)
MAKE_FUNC32(lion, LION, sycl::half, fp16)
MAKE_FUNC32(lion, LION, sycl::ext::oneapi::bfloat16, bf16)
MAKE_FUNC32(adagrad, ADAGRAD, float, 32)
MAKE_FUNC32(adagrad, ADAGRAD, sycl::half, 16)
...
MAKE_FUNC8(adam, ADAM, sycl::half, 16)
MAKE_FUNC8(momentum, MOMENTUM, float, 32)
MAKE_FUNC8(momentum, MOMENTUM, sycl::half, 16)
MAKE_FUNC8(rmsprop, RMSPROP, float, 32)
MAKE_FUNC8(rmsprop, RMSPROP, sycl::half, 16)
MAKE_FUNC8(lion, LION, float, 32)
MAKE_FUNC8(lion, LION, sycl::half, 16)
...
MAKE_BLOCKWISE8(adam, ADAM, sycl::half, fp16)
MAKE_BLOCKWISE8(adam, ADAM, float, fp32)
MAKE_BLOCKWISE8(momentum, MOMENTUM, sycl::half, fp16)
MAKE_BLOCKWISE8(momentum, MOMENTUM, float, fp32)
MAKE_BLOCKWISE8(rmsprop, RMSPROP, sycl::half, fp16)
MAKE_BLOCKWISE8(rmsprop, RMSPROP, float, fp32)
MAKE_BLOCKWISE8(adagrad, ADAGRAD, sycl::half, fp16)
MAKE_BLOCKWISE8(adagrad, ADAGRAD, float, fp32)
MAKE_BLOCKWISE8(adam, ADAM, sycl::ext::oneapi::bfloat16, bf16)
MAKE_BLOCKWISE8(lion, LION, sycl::half, fp16)
MAKE_BLOCKWISE8(lion, LION, float, fp32)
MAKE_BLOCKWISE8(lion, LION, sycl::ext::oneapi::bfloat16, bf16)


void percentileClipping_g32(float * g, float *gnorm_vec, int step, const int n){ percentileClipping<float>(g, gnorm_vec, step, n); }
void percentileClipping_g16(sycl::half * g, float *gnorm_vec, int step, const int n){ percentileClipping<sycl::half>(g, gnorm_vec, step, n); }

void quantizeBlockwise_fp16(float * code, sycl::half *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise<sycl::half, 0, General8bit>(code, A, absmax, out, NULL, 0, blocksize, n); }
void quantizeBlockwise_fp16_fp4(float * code, sycl::half *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise<sycl::half, 0, FP4>(NULL, A, absmax, out, NULL, 0, blocksize, n); }
void quantizeBlockwise_fp16_nf4(float * code, sycl::half *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise<sycl::half, 0, NF4>(NULL, A, absmax, out, NULL, 0, blocksize, n); }

void quantizeBlockwise_bf16(float * code, sycl::ext::oneapi::bfloat16 *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise<sycl::ext::oneapi::bfloat16, 0, General8bit>(code, A, absmax, out, NULL, 0, blocksize, n); }
void quantizeBlockwise_bf16_fp4(float * code, sycl::ext::oneapi::bfloat16 *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise<sycl::ext::oneapi::bfloat16, 0, FP4>(NULL, A, absmax, out, NULL, 0, blocksize, n); }
void quantizeBlockwise_bf16_nf4(float * code, sycl::ext::oneapi::bfloat16 *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise<sycl::ext::oneapi::bfloat16, 0, NF4>(NULL, A, absmax, out, NULL, 0, blocksize, n); }
...
void dequantizeBlockwise_fp16(float *code, unsigned char *A, float *absmax, sycl::half *out, int blocksize, const int n){ dequantizeBlockwise<sycl::half, General8bit>(code, A, absmax, out, blocksize, n); } \
void dequantizeBlockwise_fp16_fp4(float *code, unsigned char *A, float *absmax, sycl::half *out, int blocksize, const int n){ dequantizeBlockwise<sycl::half, FP4>(NULL, A, absmax, out, blocksize, n); } \
void dequantizeBlockwise_fp16_nf4(float *code, unsigned char *A, float *absmax, sycl::half *out, int blocksize, const int n){ dequantizeBlockwise<sycl::half, NF4>(NULL, A, absmax, out, blocksize, n); } \
...
void dequantizeBlockwise_bf16(float *code, unsigned char *A, float *absmax, sycl::ext::oneapi::bfloat16 *out, int blocksize, const int n){ dequantizeBlockwise<sycl::ext::oneapi::bfloat16, General8bit>(code, A, absmax, out, blocksize, n); }
...
extern "C"
{
	...
	void cestimate_quantiles_fp16(sycl::half *A, float *code, float offset, int n){ estimateQuantiles_fp16(A, code, offset, n); }
	void cquantize(float *code, float *A, unsigned char *out, int n){ quantize(code, A, out, n); }
	void cdequantize(float *code, unsigned char *A, float *out, int n){ dequantize(code, A, out, n); }

  void cdequantize_blockwise_fp16_fp4(float *code, unsigned char *A, float *absmax, sycl::half *out, int blocksize, const int n){ dequantizeBlockwise_fp16_fp4(code, A, absmax, out, blocksize, n); }
  void cdequantize_blockwise_fp16(float *code, unsigned char *A, float *absmax, sycl::half *out, int blocksize, const int n){ dequantizeBlockwise_fp16(code, A, absmax, out, blocksize, n); }
  void cdequantize_blockwise_fp16_nf4(float *code, unsigned char *A, float *absmax, sycl::half *out, int blocksize, const int n){ dequantizeBlockwise_fp16_nf4(code, A, absmax, out, blocksize, n); }

  void cquantize_blockwise_fp16(float * code, sycl::half *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise_fp16(code, A, absmax, out, blocksize, n); }
  void cquantize_blockwise_fp16_fp4(float * code, sycl::half *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise_fp16_fp4(code, A, absmax, out, blocksize, n); }
  void cquantize_blockwise_fp16_nf4(float * code, sycl::half *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise_fp16_nf4(code, A, absmax, out, blocksize, n); }
  ...
  void cquantize_blockwise_bf16(float * code, sycl::ext::oneapi::bfloat16 *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise_bf16(code, A, absmax, out, blocksize, n); }
  void cquantize_blockwise_bf16_fp4(float * code, sycl::ext::oneapi::bfloat16 *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise_bf16_fp4(code, A, absmax, out, blocksize, n); }
  void cquantize_blockwise_bf16_nf4(float * code, sycl::ext::oneapi::bfloat16 *A, float *absmax, unsigned char *out, int blocksize, const int n){ quantizeBlockwise_bf16_nf4(code, A, absmax, out, blocksize, n); }

  void cdequantize_blockwise_bf16(float *code, unsigned char *A, float *absmax, sycl::ext::oneapi::bfloat16 *out, int blocksize, const int n){ dequantizeBlockwise_bf16(code, A, absmax, out, blocksize, n); }
  void cdequantize_blockwise_bf16_fp4(float *code, unsigned char *A, float *absmax, sycl::ext::oneapi::bfloat16 *out, int blocksize, const int n){ dequantizeBlockwise_bf16_fp4(code, A, absmax, out, blocksize, n); }
  void cdequantize_blockwise_bf16_nf4(float *code, unsigned char *A, float *absmax, sycl::ext::oneapi::bfloat16 *out, int blocksize, const int n){ dequantizeBlockwise_bf16_nf4(code, A, absmax, out, blocksize, n); }
	...
	MAKE_CFUNC32(adam, sycl::half, fp16)
	MAKE_CFUNC32(adam, sycl::ext::oneapi::bfloat16, bf16)
	MAKE_CFUNC32(momentum, float, 32)
	MAKE_CFUNC32(momentum, sycl::half, 16)
	MAKE_CFUNC32(rmsprop, float, 32)
	MAKE_CFUNC32(rmsprop, sycl::half, 16)
	MAKE_CFUNC32(lion, float, fp32)
	MAKE_CFUNC32(lion, sycl::half, fp16)
	MAKE_CFUNC32(lion, sycl::ext::oneapi::bfloat16, bf16)
	MAKE_CFUNC32(adagrad, float, 32)
	MAKE_CFUNC32(adagrad, sycl::half, 16)
  ...
  {  \
	...
	MAKE_CFUNC8(adam, sycl::half, 16)
	MAKE_CFUNC8(momentum, float, 32)
	MAKE_CFUNC8(momentum, sycl::half, 16)
	MAKE_CFUNC8(rmsprop, float, 32)
	MAKE_CFUNC8(rmsprop, sycl::half, 16)
	MAKE_CFUNC8(lion, float, 32)
	MAKE_CFUNC8(lion, sycl::half, 16)
  ...
  {	fname##_8bit_blockwise_grad_##gbits(p, g, state1, state2, beta1, beta2, eps, step, lr, quantiles1, quantiles2, absmax1, absmax2, weight_decay, gnorm_scale, skip_zeros, n); } \
	...
	MAKE_CBLOCKWISE8(adam, ADAM, sycl::half, fp16)
	MAKE_CBLOCKWISE8(adam, ADAM, float, fp32)
	MAKE_CBLOCKWISE8(momentum, MOMENTUM, sycl::half, fp16)
	MAKE_CBLOCKWISE8(momentum, MOMENTUM, float, fp32)
	MAKE_CBLOCKWISE8(rmsprop, RMSPROP, sycl::half, fp16)
	MAKE_CBLOCKWISE8(rmsprop, RMSPROP, float, fp32)
	MAKE_CBLOCKWISE8(adagrad, ADAGRAD, sycl::half, fp16)
	MAKE_CBLOCKWISE8(adagrad, ADAGRAD, float, fp32)
	MAKE_CBLOCKWISE8(adam, ADAM, sycl::ext::oneapi::bfloat16, bf16)
	MAKE_CBLOCKWISE8(lion, LION, sycl::half, fp16)
	MAKE_CBLOCKWISE8(lion, LION, float, fp32)
	MAKE_CBLOCKWISE8(lion, LION, sycl::ext::oneapi::bfloat16, bf16)
  ...
  void cdouble_rowcol_quant(sycl::half * A, float *rowStats, float *colStats, char *out_col_normed, char *out_row_normed, int *rowidx, int *colidx, sycl::half *val, int *nnz_row_ptr, float threshold, int rows, int cols)
...
*/
	...
	void cgemm_host_fp16(int M, int N, int K, sycl::half * A,  sycl::half* B,  sycl::half * out,  int lda, int ldb, int ldc)
  ...
  #define CMAKE_ELEMENTWISE_FUNC(fname, type_name, ctype, FUNC) \
	...
	void cgemm_4bit_inference_naive_fp16(int m, int n, int k, sycl::half * A,  unsigned char* B,  float *absmax, float *datatype, sycl::half * out,  int lda, int ldb, int ldc, int blocksize)
	{ gemm_4bit_inference_naive_fp16(m, n, k, A, B, absmax,  datatype, out, lda, ldb, ldc, blocksize); }

	void cgemm_4bit_inference_naive_bf16(int m, int n, int k, sycl::ext::oneapi::bfloat16 * A,  unsigned char* B,  float *absmax, float *datatype, sycl::ext::oneapi::bfloat16 * out,  int lda, int ldb, int ldc, int blocksize)
